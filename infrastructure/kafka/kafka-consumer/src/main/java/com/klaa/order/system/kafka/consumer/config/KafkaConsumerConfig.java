package com.klaa.order.system.kafka.consumer.config;

import com.klaa.order.system.kafka.config.KafkaConfigData;
import com.klaa.order.system.kafka.config.KafkaConsumerConfigData;
